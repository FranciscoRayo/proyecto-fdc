...
/**
 * Nombre Clase: EmployeeControllerTest.java Descripcion: Clase que recoge las
 * pruebas Mock del controlador de empleados Fecha: 19/05/2021 Version: 1.0
...
public class EmployeeControllerTest {
	...
	public void test_project_fail_400() throws Exception {
		final MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/backoffice/equipo/edit/1");
	...
	public void test_project_fail_400_v2() throws Exception {
		final MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/backoffice/equipo/edit/aaaa");
		this.mockMvc.perform(requestBuilder).andDo(MockMvcResultHandlers.print())
				.andExpect(MockMvcResultMatchers.status().is4xxClientError());
	}
